...
Meteor.startup(function() {
    ...
    console.log('********* we try to register a notification on this URL: HTTP.post(http://' + senseConfig.SenseServerInternalLanIP + '/' + senseConfig.virtualProxy + '/qrs/notification?name=app');
