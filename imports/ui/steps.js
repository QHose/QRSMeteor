...
Template.steps.onRendered(function() {
    this.$('.step')
        .popup({
            title: 'Demo steps',
            content: 'This demo simulates the SaaS platform admin console of an OEM partner. In order to finish the demo, you must complete these 4 steps. If you just started we already selected some dummy customers and a an app. In step 3 we will give each of your customers a private copy of this app. In step 4 you can test Qlik Sense embedded with some users.',
            delay: {
                show: 500,
                hide: 0
            }
