...
module.exports = {
    ...
    requestTicket: function (req, res, profile, options) {
        ...
        console.log('** The Settings QlikAUTH uses are:');
        ...
        var ticketreq = https.request(settings, function (ticketres) {
            ticketres.on('data', function (d) {
                ...
                console.log('Meteor received a ticket from Qlik Sense: '+ticket.Ticket);
                ...
                console.log('Now redirect the user to: '+redirectURI);
